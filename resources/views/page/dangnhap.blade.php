		...
		<div class="container">
			<div class="row" style="justify-content: center;">
				...
				<div class="col-md-8 p-b-30">
					<h3 class="m-text26 p-t-15 p-b-16 t-center" style="justify-content: center;">
						Chào {{Auth::user()->name}} !!!
					</h3>
				</div>
				@else
				<div class="col-md-8 p-b-30">
					<h3 class="m-text26 p-t-15 p-b-16 t-center">
						Đăng nhập
					</h3>
					
					<form action="{{route('login')}}" method="post" class ="formdangnhap">
						...
						<div class="pos-relative bo11 of-hidden">							
							<input type="text" name="email" id="email" class="s-text7 size16 p-l-23 p-r-50">
						</div>
