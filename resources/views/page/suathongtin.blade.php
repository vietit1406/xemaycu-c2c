				...
				<div class="p-b-30" style="width: 20%">
					<div style="">
						<div class="hov-img-zoom">
							<img src="source/images/avatar/{{$iduser->avatar}}" alt="IMG-ABOUT" width="200px" height="200px">
						</div>
					</div>
				</div>
				<span class="linedivide1" style="height: auto;"></span>
				<div style="width: 900px">
					<form action="{{route('suathongtin',$iduser->id)}}" method="post" enctype="multipart/form-data" class ="formdangky">
						...
						<label>Họ tên:</label>
						<div class="pos-relative bo12 of-hidden size25">							
							<input type="text" name="hoten" value="{{$iduser->name}}" id="hoten" class="s-text7 size16 p-l-23 p-r-50">
						</div>
						@endif
						...
						<label>CMND:</label>
						<div class="pos-relative bo12 of-hidden size25">							
							<input type="text" name="cmnd" value="{{$iduser->cmnd}}" id="cmnd" class="s-text7 size16 p-l-23 p-r-50">
						</div>
						@endif
						
						@if(isset($_REQUEST['diachi']))
						<label>Địa chỉ:</label>
						<div class="pos-relative bo12 of-hidden size25" style="clear: both;">				
							<input type="text" name="diachi" id="diachi" value="{{$_REQUEST['diachi']}}" class="s-text7 size16 p-l-23 p-r-50">
						</div>
						@else
						<label>Địa chỉ:</label>
						<div class="pos-relative bo12 of-hidden size25" style="clear: both;">				
							<input type="text" name="diachi" id="diachi" value="{{$iduser->diachi}}" class="s-text7 size16 p-l-23 p-r-50">
						</div>
						@endif
						...
						<div class="pos-relative bo12 of-hidden size25">							
							<input type="password" name="password" value="" id="password" class="s-text7 size16 p-l-23 p-r-50 pass ">
						</div>

						<label style="position: absolute;left:120px;top:500px;">Ảnh đại diện :</label>
						<div class="pos-relative m-b-15 of-hidden size26" style="clear: both;position: absolute;left:120px;top:530px;width: 270px;">								
							<input type="file" name="avatar" value="" id="avatar" style="width: 250px" >
						</div>
						<label></label>
